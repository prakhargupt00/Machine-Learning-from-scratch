# -*- coding: utf-8 -*-
"""
# degree 6 with L1 regularisation 
"""
...
data = np.append(data,(data[0:,1]**5).reshape(-1,1),axis=1)
data = np.append(data,(data[0:,2]**5).reshape(-1,1),axis=1)
data = np.append(data,((data[0:,1]**4)*(data[0:,2])).reshape(-1,1),axis=1)
data = np.append(data,((data[0:,1])*(data[0:,2]**4)).reshape(-1,1),axis=1)
data = np.append(data,((data[0:,1]**2)*(data[0:,2]**3)).reshape(-1,1),axis=1)
data = np.append(data,((data[0:,1]**3)*(data[0:,2]**2)).reshape(-1,1),axis=1)

data = np.append(data,(data[0:,1]**6).reshape(-1,1),axis=1)
data = np.append(data,(data[0:,2]**6).reshape(-1,1),axis=1)
data = np.append(data,((data[0:,1]**5)*(data[0:,2]**1)).reshape(-1,1),axis=1)
data = np.append(data,((data[0:,1]**1)*(data[0:,2]**5)).reshape(-1,1),axis=1)
data = np.append(data,((data[0:,1]**4)*(data[0:,2]**2)).reshape(-1,1),axis=1)
data = np.append(data,((data[0:,1]**2)*(data[0:,2]**4)).reshape(-1,1),axis=1)
data = np.append(data,((data[0:,1]**3)*(data[0:,2]**3)).reshape(-1,1),axis=1)
...
for i in range(k):
  ...
  for j in range(len(w)):
    w[j] = w[j]-eta*c[j] -eta*(math.copysign(lamda,w[j]))
